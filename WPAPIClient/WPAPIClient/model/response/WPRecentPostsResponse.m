...
@implementation WPRecentPostsResponse
...
+ (WPRecentPostsResponse *)instanceFromDictionary:(NSDictionary *)aDictionary
{

    WPRecentPostsResponse *instance = [[WPRecentPostsResponse alloc] init];
